...
public class NBQueryClassifierOnline {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 加载新增的用户行为数据
        HashMap<String, HashMap<String, Double>> term2category = loadTerm2Category("/Users/huangsean/Coding/data/BigDataArchitectureAndAlgorithm/term_category_qc.txt");
	...
	//				  termsCnt ++;
	        ...
	        HashMap<String, Double> behaviorClassification = term2category.get(content);
